export const cardMainFeature = [{
  imageUrl: require('../media/features/calendar.png'),
  title: 'Calendar',
...
{
  imageUrl: require('../media/features/child_info.png'),
  title: 'Child Info',
  // eslint-disable-next-line max-len
...
{
  imageUrl: require('../media/features/law_popup.png'),
  title: 'Law Pop-up',
  // eslint-disable-next-line max-len
  content: 'The law popups are a feature that can successfully analyze what has been inputted onto a page and send back facts pertaining to child custody law or just general facts about a child’s well-being. This feature was a specific request from one of the project supervisors, Dr. Bromwich, to help differentiate the product from the rest of the field.',
  color: '#F7F5EC'
}
];

export const cardExtraFeature = [
  {
    imageUrl: require('../media/features/finance_tracker.png'),
    title: 'Finance Tracker',
    // eslint-disable-next-line max-len
    content: 'The finance tracker is a feature that allows for parents to track any expenses they have for their children. This interface acts as a ledger of all the transactions made for each child.',
  },
  {
    imageUrl: require('../media/features/to_do_list.png'),
    title: 'To-Do List',
    // eslint-disable-next-line max-len
    content: 'The finance tracker is a feature that allows for parents to track any expenses they have for their children. This interface acts as a ledger of all the transactions made for each child.',
  },
  {
    imageUrl: require('../media/features/multilingual_interface.png'),
    title: 'Multilingual Interface',
    // eslint-disable-next-line max-len
    content: 'We were able to successfully develop the application as a fully multilingual interface that allows for seamless switching between French and English. This allows the product to be catered to more demographics in Ontario.',
  },
  {
    imageUrl: require('../media/features/report_generator.png'),
